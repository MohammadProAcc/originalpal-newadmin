  ...
  async function onSubmit(form: Partial<IBanner>) {
    ...
    if (props.defaultValues) {
      ...
      try {
        ...
        const result = await search_in("banners", {
          key: "content",
          type: "=",
          value: form?.content,
        }, router?.query);
    ...
    <Form onSubmit={formMethods.handleSubmit(onSubmit)}>
      <InputGroup className="col">
        ...
        <InputGroup className="flex ali-end">
          ...
          />
          <input
            {...formMethods.register("title_color", { required: true })}
            type="color"
            placeholder="عنوان"
          />
      ...
      <InputGroup className="col mt-4">
        ...
        <InputGroup className="flex ali-end">
          ...
          <input
            {...formMethods.register("content_color", { required: true })}
            type="color"
        ...
        {props.type === "slide" && (
          <FlexContainer col style={{ marginTop: "1rem" }}>
            <InputGroup>
              <input
                {...formMethods.register("button_bg_color", { required: true })}
                type="color"
              />
            ...
            <InputGroup>
              <input
                {...formMethods.register("button_color", { required: true })}
                type="color"
              />
        ...
        <InputGroup className="mt-4">
          <label>لینک</label>
          <input
            {...formMethods.register("link", { required: true })}
            placeholder="لینک"
          />
        </InputGroup>
            ...
            render={({ field }) => (
              <Select
                ...
                defaultValue={props.defaultValues
                  ? PLATFORM_OPTIONS.find(_option =>
                    _option.value === props.defaultValues?.platform
                  )
                  : PLATFORM_OPTIONS[0]}
              />
            )}
      ...
      <InputGroup className="col m-4" style={{ position: "relative" }}>
        {props.defaultValues && (
          <BannerMedia
            ...
            as={props.defaultValues?.media.u!.includes(".mp4")
              ? "video"
              : "img"}
      ...
      <InputGroup className="col m-4">
        ...
        <InputGroup>
          <input
            {...formMethods.register("position.top")}
            placeholder="top"
            defaultValue={"auto"}
          />
        </InputGroup>
        ...
        <InputGroup>
          <input
            {...formMethods.register("position.right")}
            placeholder="right"
            defaultValue={"auto"}
          />
        </InputGroup>
        ...
        <InputGroup>
          <input
            {...formMethods.register("position.bottom")}
            placeholder="bottom"
            defaultValue={"auto"}
          />
        </InputGroup>
        ...
        <InputGroup>
          <input
            {...formMethods.register("position.left")}
            placeholder="left"
            defaultValue={"auto"}
          />
        </InputGroup>
      ...
      <InputGroup status="Success">
        <Button
          ...
          type="submit"
        >
          {loadingList.includes("submitting")
            ? "..."
            : props.defaultValues
            ? "بروزرسانی بنر"
            : "افزودن بنر"}
